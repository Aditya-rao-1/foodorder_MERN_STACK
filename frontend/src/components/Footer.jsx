import { copyrightSign, logogo } from "../../public/assets";
...
const Footer = () => {
  return (
    <Section id="footer" crosses>
    <footer className='px-5 md:px-10 lg:px-15 pt-5 bg-black'>
      <div className='flex justify-between items-start gap-20 flex-wrap max-lg:flex-col'>
        <div className='flex flex-col items-start'>
          ...
          GoMeal brings you delicious meals from your favorite restaurants, delivered fresh and fast.
We believe in good food, convenience, and making every meal a moment to enjoy.
Order now.
          </p>
